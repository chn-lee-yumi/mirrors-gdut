...
SECTION_TEMPLATE = Template("""
                    <tr class="${row_class}">
                        ...
                        <td data-label="同步时间"><code style="display: inline-flex; align-items: center; gap: 4px;">${sync_time}</code></td>
                        <td data-label="同步状态">${sync_status}</td>
                        <td data-label="下载次数">${download_count}</td>
                        <td data-label="使用帮助">
...
<footer id="footer">
    <div>
        ...
        &nbsp;|&nbsp;
        <a target="_blank" href="https://mirrors.gdut.edu.cn/help/">
            <svg width="16" height="16" style="vertical-align: middle;" fill="currentColor" viewBox="0 0 20 20">
